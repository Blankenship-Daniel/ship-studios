...
description: "Use when running the UADx Hitsville EQ Mastering (UA's Motown disk-mastering EQ) for broad, musical 'Motown' tone or Mid/Side mastering on a 2-bus, master, drum bus, or stem — 'Hitsville EQ', 'Motown mastering EQ', 'that Motown low end / Motown sound', 'mid-side master EQ', 'half-speed mastering EQ'. The measured deep-dive of [[vst-eq]] / [[vst-master]]; BROAD/musical, not surgical (pair with [[fabfilter-pro-q-4]]). Stemmy MCP, the `vst` extra."
