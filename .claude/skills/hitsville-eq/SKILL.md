---
name: hitsville-eq
description: "Use when running the UADx Hitsville EQ (the single-channel Studio EQ — UA's model of the custom Motown / Hitsville U.S.A. 7-band graphic EQ) for fast, forgiving 'Motown' tone on drums, bus, bass, vocals, or a mix bus — 'Hitsville EQ', 'Motown EQ', 'that Motown sound / butter EQ', '7-band Motown graphic EQ'. The plugin-specific deep-dive of [[vst-eq]]; the channel counterpart to the Mid/Side mastering twin [[hitsville-eq-mastering]]. Stemmy MCP, the `vst` extra."
