...
description: "Use when running the SSL Native Channel Strip 2 for clean/precise console tone, glue, surgical EQ, or gating on a stem or bus — 'SSL Native Channel Strip 2', 'that clean SSL console sound', 'gate the snare with the SSL', 'XL 9000K 4-band EQ'. The plugin-specific deep-dive of [[vst-channel-strip]]. Stemmy MCP, the `vst` extra."
