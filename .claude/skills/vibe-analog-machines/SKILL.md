...
description: "Use when running the UAD/UADx Vibe Analog Machines (formerly Verve Analog Machines) for fast analog 'vibe' on a drum bus, loop, stem, beat, or mix bus — 'Vibe Analog Machines', 'Verve Analog Machines', 'UAD Vibe', 'add some vibe/character', 'lo-fi / vintage / tape / wobble it', 'sputter / glow this'. The plugin-specific deep-dive of [[vst-saturate]]. Stemmy MCP, the `vst` extra."
